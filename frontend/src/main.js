...
pluralCaseList.push( {plural: "filelayoutids", pascal: "Filelayoutid"} )

pluralCaseList.push( {plural: "indexinformations", pascal: "Indexinformation"} )

pluralCaseList.push( {plural: "indices", pascal: "Index"} )



pluralCaseList.push( {plural: "dsshBoarves", pascal: "DsshBoarf"} )
